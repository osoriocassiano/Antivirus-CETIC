                ...
                @foreach($cargo as $carg)
                    <tr>
                        ...
                        <td class="top-bar-right">
                            ...
                            <a href="{{route('cargo.edit', $carg->carg_codigo) }}" class="tiny success button"><i class="fi-pencil"></i></a>
                            <a href="{{route('cargo.show', $carg->carg_codigo)}}" class="tiny alert button"><i class="fi-trash"></i> </a>
